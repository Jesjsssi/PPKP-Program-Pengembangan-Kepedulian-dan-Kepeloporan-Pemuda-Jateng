...
public class frmLogin extends javax.swing.JFrame {
    ...
    public frmLogin() {
        initComponents();
        open_db();
        getContentPane().setBackground(Color.getHSBColor(139, 71, 38));
    }
    ...
    private void cmdOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOkActionPerformed
        ...
        try {
            ...
            RsUser=stm.executeQuery("select * from data_user where user_id='"+txtUserId.getText()+"' and user_password=('"+password+"')");
            int baris=0;
            while(RsUser.next()) {
                baris = RsUser.getRow();
